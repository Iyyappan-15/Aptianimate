  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        maxWidth: '420px',
        width: '100%',
        boxShadow: '0 20px 40px rgba(0,0,0,0.06), inset 0 1px 0 rgba(255,255,255,0.6)',
        ...
        <p style={{
          fontSize: '1rem', color: '#64748b', marginBottom: '32px', lineHeight: '1.6'
        }}>
          {message}
        </p>
        ...
        <button 
          ...
          style={{
            ...
            fontSize: '1.05rem', padding: '14px 28px', background: '#ffffff',
            color: '#334155', width: '100%', borderRadius: '16px',
      ...
      <style>{`
        ...
        @media (prefers-color-scheme: dark) {
          ...
          .auth-prompt-title { color: #f8fafc !important; }
          .auth-prompt-desc { color: #94a3b8 !important; }
          .auth-prompt-btn {
